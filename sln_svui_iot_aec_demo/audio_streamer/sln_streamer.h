...
/*!
 * @brief Resume audio playback for the streamer interface
 *
 * @param handle Pointer to input handle
 */
...
/*!
 * @brief Check if streamer interface is paused
 *
 * @param handle Pointer to input handle
...
/*!
 * @brief Check if streamer interface reached EOS
 *
 * @param handle Pointer to input handle
 * @return true if EOS reached, false if not
 */
